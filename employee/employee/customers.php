...
require_employee(); // employees can view customers too
        ...
        <div class="col-12 col-md-6 col-lg-4 customer-card-wrapper" data-name="<?= strtolower(htmlspecialchars($c['name'])) ?>" data-phone="<?= htmlspecialchars($c['phone'] ?? '') ?>">
            <div class="custom-card p-3">
                ...
                <div class="d-flex gap-2">
                    <a href="pos.php?customer_id=<?= $c['id'] ?>" class="btn btn-outline-primary btn-sm flex-grow-1"><i class="bi bi-cart-plus me-1"></i>New Bill</a>
                    <a href="customer-ledger.php?id=<?= $c['id'] ?>" class="btn btn-outline-secondary btn-sm flex-grow-1"><i class="bi bi-journal-text me-1"></i>Ledger</a>
                    <a href="receive-payment.php?id=<?= $c['id'] ?>" class="btn btn-primary btn-sm flex-grow-1"><i class="bi bi-cash-coin me-1"></i>Pay</a>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
