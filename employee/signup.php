...
<div class="login-card text-center">
    ...
    <form id="signupForm">
        ...
        <button class="btn btn-primary w-100 py-2 mb-3" type="submit" id="signupBtn">Sign up</button>
        
        <p class="text-muted small">Already have an account? <a href="login.php" class="text-decoration-none">Sign in</a></p>
    </form>
</div>
