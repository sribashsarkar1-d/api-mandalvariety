    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if (!in_array($ext, $allowedExt, true)) {
            ...
            if (move_uploaded_file($tmp, $uploadDir . $newName)) {
                ...
                if (!empty($category['image']) && is_file(__DIR__ . '/../uploads/' . $category['image'])) {
...
<style>
    ...
    .page-header-premium {
        ...
        color: white;
        margin-bottom: 30px;
        box-shadow: 0 15px 30px rgba(3, 105, 161, 0.2);
        display: flex;
                ...
                <div class="col-lg-8">
                    <div class="premium-card mb-4">
                        <div class="premium-card-header">
                            <i class="fa-solid fa-info-circle text-primary"></i> Category Details
                        </div>
                        ...
                        <div class="premium-card-body text-center">
                            ...
                            <?php if (!empty($category['image'])): ?>
                                <div class="img-preview-card mt-0 mb-3" style="display:block;">
                                    <img src="../uploads/<?= e($category['image']) ?>" alt="Current Image">
                                </div>
                            <?php endif; ?>
